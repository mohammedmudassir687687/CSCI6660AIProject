...
class State:
    ...
    # rotate the cube 90 degrees counter clockwise  // the rotation is such that front goes to the right
    ...
    # swap the first row of two given sides, in place   // keeping the two rows as same [1:], swapping the first row
